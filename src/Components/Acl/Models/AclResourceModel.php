...
{
    public const string TABLE_NAME = 'acl_resources';
    ...
    /** @return HasMany<AclResourceModel, $this> */
    ...
    {
        return $this->hasMany(AclRuleModel::class, AclRuleModel::FIELD_RESOURCE_ID);
    }

    /** @return HasMany<AclRouteRuleModel, $this> */
    public function routeRules(): HasMany
    {
        return $this->hasMany(AclRouteRuleModel::class, AclRouteRuleModel::FIELD_RESOURCE_ID);
    }
}
